...
const registerAlertDefaultClass = registerAlert
  ? registerAlert.className
  : "hidden mb-4 text-center text-sm";
const otpAlertDefaultClass = otpAlert
  ? otpAlert.className
  : "hidden mb-4 text-center text-sm";
...
if (registerForm) {
  registerForm.addEventListener("submit", async (e) => {
    ...
    try {
      ...
      registerAlert.className =
        "p-3 rounded-lg text-center text-white font-semibold bg-red-500";
      registerAlert.classList.remove("hidden");
    }
  });
}
