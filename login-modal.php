    ...
    <div class="bg-white rounded-lg shadow-xl w-full max-w-md mx-4">
        <div class="p-6">
                ...
                <div class="flex items-center justify-between">
                    ...
                    <div class="text-sm">
                        <a href="#" id="forgotPasswordLink"
                            class="font-medium text-primary hover:text-opacity-80">Forgot password?</a>
                    </div>
                </div>
                <div>
            ...
            <div class="mt-4 text-center text-sm text-gray-600">
                ...
                <a href="#" id="openRegisterModal" class="font-medium text-primary hover:text-opacity-80">Register
                    Here</a>
            </div>
        </div>
    </div>
...
<div id="forgotPasswordModal"
    ...
    <div class="bg-white rounded-lg shadow-xl w-full max-w-md mx-4">
        <div class="p-6">
            ...
            <label class="block text-sm font-medium text-gray-700 text-center">Please check your email for a message
                with your code. Your code is 6 numbers long.</label>
